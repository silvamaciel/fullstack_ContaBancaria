...
import com.apibanco.contabancaria.Exception.ContaNotFoundException;
...
public class ContaService {
    ...
    public ContaBancaria getContaByNumero(String numeroDaConta) {
        ContaBancaria conta = contaRepository.findByNumeroDaConta(numeroDaConta);
        if (conta == null) {
            throw new ContaNotFoundException("Conta não encontrada para o número: " + numeroDaConta);
        }
        return conta;
    }
    ...
    public ContaBancaria getContaById(Long id) {
        return contaRepository.findById(id)
                .orElseThrow(() -> new ContaNotFoundException("Conta não encontrada para o ID: " + id));
    }
